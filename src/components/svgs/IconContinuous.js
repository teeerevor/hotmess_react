...
export const IconContinuous = ({className}) => {
  const classes = cx(styles.back);
  //const classes = cx(styles.pause, this.props.className);
  return (
    <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="25.21" height="24.27" viewBox="0 0 25.21 24.27" aria-labelledby="title">
