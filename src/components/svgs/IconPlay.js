...
export default class IconPlay extends React.Component {
  render() {
    const classes = cx(styles.play);
    //const classes = cx(styles.play, this.props.className);

    return (
      <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="15.27" height="20" viewBox="0 0 15.27 20" aria-labelledby="title">
